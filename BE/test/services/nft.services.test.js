...
jest.mock("../../src/services/ipfs.services", () => ({
  formatIPFSUrl: jest.fn((uri) =>
    uri ? `https://ipfs.io/ipfs/${uri.replace("ipfs://", "")}` : null
  ),
...
describe("PostServices", () => {
  ...
  describe("processMentions", () => {
    test("should process an array of mentions", async () => {
      ...
      jest
        .spyOn(PostServices, "findUserFromMention")
  ...
  describe("createPost", () => {
    test("should create a post successfully", async () => {
      ...
      User.findOne.mockResolvedValue(mockUser);
      jest
        .spyOn(PostServices, "processMentions")
        .mockResolvedValue(mockProcessedMentions);
