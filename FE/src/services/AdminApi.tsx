...
type NotificationParams = PaginationParams & {
  type?: string | null;
};
...
const AdminApi = {
  ...
  createUserNotification: async (walletAddress: string, title: string, content: string) => {
    try {
      const response = await instance.post("/admin/notification", { walletAddress, title, content });
      return response.data;
    } catch (error) {
  ...
  getNotifications: async (params: NotificationParams = {}) => {
    try {
      ...
      const response = await instance.get(`/admin/notifications?${queryParams.toString()}`);
      return response.data;
    } catch (error) {
  ...
  deleteNotification: async (notificationId: string) => {
    try {
      const response = await instance.delete(`/admin/notification/${notificationId}`);
      return response.data;
    } catch (error) {
