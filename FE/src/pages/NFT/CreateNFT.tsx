...
const CreateNFT = () => {
  ...
  return (
    <div className="min-h-screen rounded-[10px] w-[1282px] bg-white text-gray-800">
      {/* Header */}
      <div className="max-w-7xl mx-auto px-4">
        <div className="flex items-center py-6">
          <button onClick={() => navigate(-1)} className="mr-4 text-gray-800 hover:text-gray-500">
            <svg
          ...
          <h1 className="text-xl font-semibold text-gray-800">Tạo NFT</h1>
        </div>
          ...
          <div className="col-span-1">
            <div className="space-y-8">
              <div className="flex items-center">
                ...
                <span className={currentStep >= 1 ? "text-gray-800" : "text-gray-500"}>Tải tệp lên</span>
              </div>
              <div className="flex items-center">
                <div
                  className={`w-6 h-6 rounded-full flex items-center justify-center mr-3 
                ...
                <span className={currentStep >= 2 ? "text-gray-800" : "text-gray-500"}>Thêm chi tiết NFT</span>
              </div>
              <div className="flex items-center">
                <div
                  className={`w-6 h-6 rounded-full flex items-center justify-center mr-3 
                ...
                <span className={currentStep >= 3 ? "text-gray-800" : "text-gray-500"}>Đúc NFT</span>
              </div>
            </div>
          </div>
          ...
          <div className="col-span-3">
                ...
                <div className="space-y-6">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-4 py-2 border border-gray-300 bg-white rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent text-gray-800"
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      className="w-full px-4 py-2 border border-gray-300 bg-white rounded-lg h-32 focus:ring-2 focus:ring-blue-500 focus:border-transparent text-gray-800"
                    ...
                    <div className="flex space-x-6">
                      <label className="flex items-center">
                        <input
                          ...
                          className="w-4 h-4 text-blue-500 border-gray-300 focus:ring-blue-500 bg-white"
                        />
            ...
            {currentStep === 3 && !showSuccessModal && (
              <div className="flex flex-col items-center justify-center min-h-[500px] bg-gray-100 rounded-lg p-8">
                <h2 className="text-2xl font-bold text-gray-800 mb-4">Quá trình đúc NFT đang diễn ra</h2>
                <p className="text-gray-600 mb-8">NFT của bạn đang được đúc, vui lòng đợi trong giây lát...</p>
      ...
      {showSuccessModal && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white rounded-lg p-8 max-w-md w-full relative border border-gray-200 shadow-xl">
            <button
            ...
            <div className="flex flex-col items-center">
              <div className="w-36 h-36 rounded-lg overflow-hidden mb-4 border border-gray-200">
                {selectedImage && (
                  <img src={selectedImage || "/placeholder.svg"} alt="NFT" className="w-full h-full object-cover" />
                )}
              </div>

              <p className="text-gray-600 text-sm mb-2">{title || "Untitled NFT"}</p>
              <h3 className="text-xl text-gray-800 font-bold text-center mb-6">Bạn đã tạo NFT thành công!</h3>

              <div className="flex gap-4 mb-8">
                <button
                  onClick={() => navigate("/add-nft/nft-view")}
                  className="px-6 py-2 border border-gray-400 rounded-full bg-white text-gray-800 hover:bg-gray-100 transition-colors"
                >
                  Xem NFT
                </button>
