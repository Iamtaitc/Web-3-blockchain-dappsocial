...
import { Bell, Send, AlertCircle, CheckCircle, Clock, Info } from "lucide-react"
...
const SystemNotifications = () => {
  ...
  const [recentNotifications, setRecentNotifications] = useState([
    {
      ...
      content: "The platform will be undergoing maintenance on June 15th from 2:00 AM to 4:00 AM UTC.",
      sentAt: "2023-06-10T12:00:00Z",
      recipientCount: 4235,
    },
    {
      id: 2,
      title: "New Feature: NFT Marketplace",
      content: "We're excited to announce the launch of our new NFT marketplace feature!",
      sentAt: "2023-06-05T15:30:00Z",
      recipientCount: 4180,
    },
  ])
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Generate a random recipient count (in a real app, this would be the actual count)
      const count = Math.floor(Math.random() * 1000) + 4000
      setRecipientCount(count)
      setNotificationStatus("success")

      // Add to recent notifications
      const newNotification = {
        id: recentNotifications.length + 1,
        title,
        content,
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="bg-white dark:bg-gray-800 shadow rounded-lg p-6">
          <h2 className="text-lg font-medium text-gray-900 dark:text-white mb-4">Send System Notification</h2>
                ...
                <div className="flex">
                  ...
                  <div className="ml-3">
                    ...
                    <div className="mt-2 text-sm text-blue-700 dark:text-blue-400">
                      <p>
                        This notification will be sent to all active users on the platform. Users will receive this
                        notification in their notification center and via email if they have email notifications
                        enabled.
                      </p>
                    </div>
                  </div>
              ...
              <div className="flex">
                ...
                <div className="ml-3">
                  ...
                  <div className="mt-2 text-sm text-green-700 dark:text-green-400">
                    <p>Your notification has been sent to {recipientCount.toLocaleString()} users.</p>
                  </div>
                </div>
              </div>
            </div>
