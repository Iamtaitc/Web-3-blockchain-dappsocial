...
const Dashboard: React.FC = () => {
  ...
  return (
    <div className="w-screen max-w-[calc(100vw-200px)] text-foreground p-20 font-mono">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
        ...
        <div className="bg-gray-900 rounded-lg p-6">
          ...
          <div className="flex justify-between items-center">
            ...
            <button className="bg-red-500 hover:bg-red-600 text-white px-4 py-2 rounded-lg text-sm">Disconnect</button>
          </div>
        </div>
      </div>
